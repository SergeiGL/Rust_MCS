...
//
// pub fn split_box_for_par<const N: usize>(u: &SVector<f64, N>, v: &SVector<f64, N>, n_boxes_to_create: usize) ->
// (
...
//         let (u_split, v_split, n_boxes_created) = split_box_for_par(&u, &v, 1);
...
//         let (u_split, v_split, n_boxes_created) = split_box_for_par(&u, &v, 2);
...
//         let u = SVector::<f64, 7>::from_row_slice(&[-5., -4., -3., -2., -1., 0., 1.]);
//         let v = SVector::<f64, 7>::from_row_slice(&[-1., 0., -1., 10., 3., 5., 10.]);
//         let (u_split, v_split, n_boxes_created) = split_box_for_par(&u, &v, 4);
...
//         let (u_split, v_split, n_boxes_created) = split_box_for_par(&u, &v, 10);
//         assert_eq!(
//             u_split,
//             vec![

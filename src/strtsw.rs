...
mod tests {
    ...
    fn test_single_element() {
        ...
        let (result_s, result_record) = strtsw::<10>(&level, &f, nboxes);
    ...
    fn test_all_zero_level() {
        ...
        let (result_s, result_record) = strtsw::<5>(&level, &f, nboxes);
    ...
    fn test_f_values_order_affect() {
        ...
        let (result_s, result_record) = strtsw::<6>(&level, &f, nboxes);
    ...
    fn test_negative_f_values() {
        ...
        let (result_s, result_record) = strtsw::<7>(&level, &f, nboxes);
